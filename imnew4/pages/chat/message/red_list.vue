<template>
  <view class="page">
    ...
    <view v-else class="whb-none">
      <image src="/static/theme//default/my/20.png"></image>
      <view class="whb-none-item">{{$t('newAdd.no_data')}}</view>
      <view class="whb-none-item2">{{$t('newAdd.gt_ten_min_show')}}</view>
    </view>
    ...
    <view class="windows" :class="windowsState">
      ...
      <view class="layer" @touchmove.stop.prevent="discard">
        <view class="open-redenvelope">
          ...
          <view class="from">{{$t('newAdd.from') + redenvelopeData.user_info.nickname + $t('newAdd.isRedbag') }}</view>
