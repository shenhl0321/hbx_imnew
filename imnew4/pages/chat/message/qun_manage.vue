			...
			<view class="page-list">
				<view class="page-item">
					<view class="page-item-left">
						<view>{{$t('c_set.qyjy')}}</view>
						<view class="page-item-info">{{$t('c_set.fy')}}</view>
					</view>
				...
				<view class="page-item">
					<view class="page-item-left">
						<view>{{$t('c_set.3')}}</view>
						<view class="page-item-info">{{$t('c_set.4')}}</view>
					</view>
					<view class="page-item-right">
				...
				<view class="page-item">
					<view class="page-item-left">
						<view>{{$t('c_set.5')}}</view>
						<view class="page-item-info">{{$t('c_set.6')}}</view>
					</view>
					<view class="page-item-right">
				...
				<view class="page-item">
					<view class="page-item-left">
						<view>{{$t('c_set.7')}}</view>
						<view class="page-item-info">{{$t('c_set.8')}}</view>
					</view>
					<view class="page-item-right">
				...
				<view class="page-item">
					<view class="page-item-left">
						<view>{{$t('c_set.9')}}</view>
						<view class="page-item-info">{{$t('c_set.10')}}</view>
					</view>
					<view class="page-item-right">
						<switch :checked="can_add_friend" @change="switch1Change" />
					</view>
				</view>
				<view class="page-item">
					<view class="page-item-left">
						<view>{{$t('c_set.19')}}</view>
						<view class="page-item-info">{{$t('c_set.20')}}</view>
					</view>
					<view class="page-item-right">
						<switch :checked="can_invite_friend" @change="switchInviteChange" />
					</view>
				</view>
				<view class="page-item">
					<view class="page-item-left">
						<view>{{$t('c_set.11')}}</view>
						<view class="page-item-info">{{$t('c_set.12')}}</view>
					</view>
					<view class="page-item-right">
				...
				<view class="footer-list">
					...
					<view class="doButton" v-show="data.is_action == 2">
						<button class="group-button" type="button" @tap="removeGroup">{{$t('c_set.18')}}</button>
					</view>
				</view>
...
<script>
	...
	export default {
		...
		onShow() {
			...
			_this.$httpSend({
				...
				success(data) {
					...
					_this.can_add_friend = data.group.can_add_friend === 0 ? true : false
					_this.can_invite_friend = data.group.can_invite_friend === 1 ? true : false
		...
		methods: {
			...
			switchInviteChange(e) {
				console.log("e.detail.value", e.detail.value)
				let _this = this,
					value = e.detail.value ? 1 : 0;
				this.$httpSend({
					path: '/im/message/typeChecked',
					data: {
						list_id: this.list_id,
						value: value,
					},
