<template>
	...
	<view class="page">
		<view class="checkall" @click="checkall()">{{$t('send_all.all_checked')}}</view>
		<!-- <view class="recurrence" @click="goPath('../push/circle')"><返回</view> -->
		<scroll-view class="scrollList" scroll-y :scroll-into-view="scrollViewId" :style="{height:winHeight + 'px'}">
			<uni-search-bar ref="searchBar2" :placeholder="$t('send_all.placeholder')" :show="false" @confirm="search"
				@search="search" style="position: absolute; z-index: 220;">
			</uni-search-bar>
			<view class="uni-list" style="position: absolute;top: 220rpx; z-index: 220;">
		...
		<view class="found-list">
			<view class="new-built" @click="goPath('../chat/messagemore')">{{$t('send_all.new_create')}}</view>
		</view>
