...
import _lang from '../lang/lang';
	...
	export default {
		...
		methods: {
			...
			*/
			about_15_15_click:function(event){
			...
			* 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
			*/
			about_22_22_click:function(event){
			...
			* 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
			*/
			about_42_42_click:function(event){
			...
			* 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
			*/
			btCopy_46_click:function(event){
			...
			* 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
			*/
			about_47_47_click:function(event){
			...
			* 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
			*/
			about_51_51_click:function(event){
			...
			* 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
			*/
			about_55_55_click:function(event){
			...
			* 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
			*/
			about_59_59_click:function(event){
