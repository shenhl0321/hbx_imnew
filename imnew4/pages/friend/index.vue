	...
	<view class="page" :style="{height:winHeight +'px',overflow:'hidden'}">
		...
		<scroll-view id="scrollcontent" class="scrollList" scroll-y :scroll-into-view="scrollViewId"
			...
			<view class="searchOut">
				<uni-search-bar ref="searchBar2" :placeholder="$t('friend.add.search')" :show="false" bgColor="#F7F7F7" @confirm="search"
				...
				<view class="listlf">
					...
					<uni-list>
						...
						<view class="uni-media-list btm_border" @click="goPath('../friend/apply-list',0)">
							...
							<view class="uni-media-list-body">
								<view class="uni-list-cell-navigate">{{$t('friend.index.new_friend')}}</view>
							</view>
						...
						<view class="uni-media-list btm_border" @click="goPath('./group_chat')">
							...
							<view class="uni-media-list-body">
								<view class="uni-list-cell-navigate">{{$t('friend.index.group_chat')}}</view>
							</view>
							<view>
						...
						<view class="uni-media-list" @tap="goPath('./chat-group-apply',1)">
							...
							<view class="uni-media-list-body">
								<view class="uni-list-cell-navigate">{{$t('friend.index.group_cert')}}</view>
							</view>
					...
					<block v-for="(list, key) in list_data" :key="key">
						...
						<view class="uni-list-cell" hover-class="none"
							...
							<uni-swipe-action :options="[ {text: $t('newAdd.remark')} ]" @tap="swipeAction(item.user_id + '')">
	...
	export default {
		...
		onShow() {
			uni.setNavigationBarTitle({
				title:this.$t('friend.index.page_title')
			})
