	...
	<view class="page">	
		<view class="header">
			<view class="input-view">
				...
				<input class="input" type="text" :placeholder="$t('newAdd.inputSearchLinker')" @input="handleInput" :focus="true" />
			</view>
		</view>
		<view class="search-main" v-if="keyword">
			<view class="search-main-errtitle" v-if="hasNoData">{{$t('newAdd.no_result')}}</view>
			<view class="uni-list">
