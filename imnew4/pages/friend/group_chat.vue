<template>
	<view class="page">
		<uni-list v-if="list.length">
			...
			<view class="uni-media-list btm_border" v-for="(value,key) in list" v-if="value.type == 1"
				@tap="goPath(value.list_id)">
				<view class="uni-media-list-logo">
					<image :src="staticPhoto + value.photo_path" class="img-icon" @error="imageError"
						:data-index="key" />

				</view>
				<view>
					<view class="text-hidden">{{value.show_name}}</view>
