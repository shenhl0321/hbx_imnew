...
<template>
  ...
  <view class="page">
    <uni-search-bar ref="searchBar"
                    :placeholder="$t('newAdd.search_log')"
                    :show="false"
                    @confirm="search"
    ...
    <view :class="['action_main animated faster',(action_menu ? 'bounceInDown' : 'bounceOutUp')]"
      ...
      <view class="action_base">
        ...
        <view class="action_item"
          ...
          <text class="action_item_text">{{$t('newAdd.sendgroupchat')}}</text>
        </view>
        ...
        <view class="action_item"
          ...
          <text class="action_item_text">{{$t('newAdd.addfriend')}}</text>
        </view>
        ...
        <view class="action_item"
          ...
          <text class="action_item_text">{{$t('newAdd.scan')}}</text>
        </view>
        <!-- #endif -->
        ...
        <view class="action_item"
          ...
          <text class="action_item_text">{{$t('newAdd.payment')}}</text>
        </view>
      </view>
    </view>
    <uni-popup ref="popup" type="confirm">
      <uni-popup-confirm :title="$t('newAdd.forward_msg')" :content="popuMsg" @confirm = "confirm"> </uni-popup-confirm>
    </uni-popup>
  </view>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      options: [
        {
          text: this.$t('newAdd.cancel'),
          style: {
            backgroundColor: '#007aff'
          }
        }, {
          text: this.$t('newAdd.delete'),
          style: {
