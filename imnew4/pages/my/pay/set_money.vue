		...
		<view class="content">
			<view class="content-main">
				...
				<view class="footer-msg">
					<view class="footer-msg-main" v-if="pagaParams.info">
						...
						<text class="footer-msg-do" @tap="editShuoming">{{$t('newAdd.edit')}}</text>
					</view>
					<view class="footer-msg-main" v-else>
						<text class="footer-msg-do" @tap="editShuoming">{{$t('my.wallet.sfk.tips2')}}</text>
					</view>
				</view>
				<view class="footer-button">
					<button class="withdraw" type="submit" @tap="setAmount">{{$t('my.wallet.sfk.qr')}}</button>
				</view>
			</view>
			<uni-popup ref="popup" type="dialog">
				<uni-popup-confirm
						...
						:placeholder="$t('newAdd.more_ten_length')"
						:title="$t('newAdd.add_desc')"
		...
		methods: {
			...
			setAmount(){
				...
				if(!_this.pagaParams.amount.trim()){
					uni.showToast({title:_this.$t('newAdd.p_input_money'),icon:'none'});
					return false;
				}
