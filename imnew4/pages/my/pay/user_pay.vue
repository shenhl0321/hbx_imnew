	...
	<view class="page">
		<view class="page-user-info">
			<view class="info-left">
				<text class="info-left-title">{{$t('newAdd.pay_to_user')}}</text>
			...
			<view class="content-main">
				...
				<view class="footer-msg">
					...
					<view class="footer-msg-main" v-else>
						<text class="footer-msg-do" @tap="editShuoming">{{$t('newAdd.addSay')}}</text>
					</view>
				</view>
				<view class="footer-button">
					<button class="withdraw" type="submit" @tap="payAmount">{{$t('newAdd.certain')}}</button>
				</view>
			</view>
		</view>
