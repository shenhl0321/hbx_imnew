	...
	<view class="page">
		<view class="content">
			<view class="charge-head">
				...
				<view class="charge">
					<input class="uni-input" type="number" placeholder-class="placeholder" :value="amount" focus
						placeholder="" @input="doAmount" />
				</view>
			...
			<view class="charge-footer">
				...
				<view class="charge-channel">
					<!-- <view class="msg"> -->
					<view style="margin-left: 70upx;position: absolute;">{{$t('cz.xz')}}</view>
					<!-- </view> -->
					<view class="chanel-img">
						<view class="check-img">
							...
							<label class="radio" data-index="7" @tap="selectTab">
								...
								<text>{{$t('cz.alipay')}}</text>
							</label>
						</view>
					</view>
					<button class="charge" type="button" @tap="charge">{{$t('cz.cm')}}</button>
				</view>
			</view>
		</view>
	</view>
	...
	export default {
		...
		methods: {
			...
			charge() {
				...
				if (this.amount <= 0) {
					uni.showToast({
						title: this.$t('newAdd.p_input_money'),
						duration: 1000,
						icon: "none"
					});
				}
