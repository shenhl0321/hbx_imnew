                            ...
                            <block v-for="(menuList2,index3) in menuLists" :key="index3">
								...
								<view class="tab-item">
									...
									<view  class="aui-mail-payment">
										<view>
												{{menuList2.is_buyer == 1 ? $t("newAdd.buy_menu") : $t("newAdd.sell_menu")}}{{$t("newAdd.payment")}}{{menuList2.amount}}
										</view>
									</view>
									<view class="aui-mail-button">
										...
										<text  @tap="goPath(menuList2)" class="aui-df-color">{{menuList2.is_buyer == 1  || menuList2.logistics_status != 1? $t("newAdd.see_detail") : $t("newAdd.go_deliver")}}</text>
...
<script>
	...
	export default {
		...
		onLoad() {
			...
			this.menuTabs = [
					{
						name: this.$t('newAdd.all'),
						status:-1
					}, {
						name: this.$t('newAdd.buy'),
						status:1
					}, {
						name: this.$t('newAdd.sell'),
						status:2
					}
