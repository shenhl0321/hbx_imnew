<template name="yq-avatar">
	<view>
		<image :src="imgSrc.imgSrc" @click="fSelect" :style="[ iS ]" mode="aspectFill" class="my-avatar"></image>
		...
		<view class="oper-wrapper" :style="{display: sD, top:tp}">
			<view class="oper">
				<view class="btn-wrapper" v-if="sO">
					<view @click="fSelect" hover-class="hover" :style="{width: bW}"><text>{{$t('photo.1')}}</text></view>
					<view @click="fClose" hover-class="hover" :style="{width: bW}"><text>{{$t('photo.2')}}</text></view>
					<view @click="fRotate" hover-class="hover" :style="{width: bW, display: bD}"><text>{{$t('photo.3')}}</text></view>
					<view @click="fPreview" hover-class="hover" :style="{width: bW}"><text>{{$t('photo.4')}}</text></view>
					<view @click="fUpload" hover-class="hover" :style="{width: bW}"><text>{{$t('photo.5')}}</text></view>
				</view>
				<view class="clr-wrapper" v-else>
					...
					<view @click="fPrvUpload" hover-class="hover" :style="{width: bW}"><text>{{$t('photo.5')}}</text></view>
				</view>
			</view>
		</view>
	</view>
